...
protected: varType varName; public: virtual inline varType get##funName(void) { return varName; }

#define G_SYNTHESIZE_READONLY_REF(varType, varName, funName)\
protected: varType varName; public: virtual inline varType& get##funName(void) { return varName; }

#define G_SYNTHESIZE_READONLY_PASS_BY_REF(varType, varName, funName)\
